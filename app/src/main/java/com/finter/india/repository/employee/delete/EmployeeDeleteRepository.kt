package com.finter.india.repository.employee.delete
...
class EmployeeDeleteRepository @Inject constructor(
    ...
    suspend fun deleteEmployee(
        ...
        client.deleteEmployee(customer_id) {
            it.onSuccess {
        ...
        liveData.apply { postValue(EmployeeDetailsResponse(false, "", null)) }
    }
}